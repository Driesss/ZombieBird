package be.driesstelten.zombiebird.gameworld;
...
import be.driesstelten.zombiebird.gameobjects.Grass;
import be.driesstelten.zombiebird.gameobjects.Pipe;
import be.driesstelten.zombiebird.gameobjects.ScrollHandler;
import be.driesstelten.zombiebird.tweenaccessors.Value;
import be.driesstelten.zombiebird.tweenaccessors.ValueAccessor;
...
public class GameRenderer {
    ...
    public void render(float delta, float runTime) {
        ...
        // This is good for performance when images that do not require
        // transparency
        ...
        // The bird and skulls need transparency, so we enable that again.
